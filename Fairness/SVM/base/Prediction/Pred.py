...
base_path = "./Fairness/SVM/base/Prediction"
...
model_ITC = joblib.load("./Fairness/SVM/base/InviteToConduct/model/model.pkl")
...
model_OTR = joblib.load(f"Fairness/SVM/base/OfferToRegister/model/model.pkl")
