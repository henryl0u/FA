...
base_path = "./Fairness/CB/reweight/InviteToConduct/"
...
def classification_model(
    ...
    # Define and train CatBoost model with fairness-based sample weights
    ...
    grid_search_cv.fit(X_train, y_train, eval_set=(X_val, y_val), sample_weight=w_train, verbose=False)

    best_clf = grid_search_cv.best_estimator_

    # Apply sample weights during calibration if enabled
    if calibrate:
    ...
    # Save model predictions and likelihood scores
