...
base_path = "./Fairness/CB/reweight/Prediction"
...
model_ITC = joblib.load("./Fairness/CB/reweight/InviteToConduct/model/model.pkl")
...
model_OTR = joblib.load(f"Fairness/CB/reweight/OfferToRegister/model/model.pkl")
