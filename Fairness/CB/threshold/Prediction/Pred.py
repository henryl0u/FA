...
base_path = "./Fairness/CB/threshold/Prediction"
...
optimizer_ITC = joblib.load("./Fairness/CB/threshold/InviteToConduct/model/optimizer.pkl")
...
optimizer_OTR = joblib.load("./Fairness/CB/threshold/OfferToRegister/model/optimizer.pkl")
