...
base_path = "./Fairness/CB/egr/InviteToConduct/"
...
def classification_model(
    ...
    print(
        f"Training EGR model using fairness constraint: {fairness_metric} and sensitive attribute: ethnicity"
    )
    ...
    likelihood_df.to_excel(f"{save_dir}/interview_likelihood_val.xlsx", index=False)
...
def likelihood_prediction(
    ...
    X_pred_proc = pred_data[features]
