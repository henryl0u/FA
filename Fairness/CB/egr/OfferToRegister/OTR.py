...
base_path = "./Fairness/CB/egr/OfferToRegister/"
...
def classification_model(
    ...
    egr_model.fit(X_train, y_train, sensitive_features=A_train)

    y_val_probs = egr_predict_proba(egr_model, X_val)
