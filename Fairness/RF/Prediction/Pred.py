...
base_path = "./Fairness/RF/Prediction"
...
model_ITC = joblib.load("./Fairness/RF/InviteToConduct/model/model.pkl")
...
model_OTR = joblib.load(f"Fairness/RF/OfferToRegister/model/model.pkl")
