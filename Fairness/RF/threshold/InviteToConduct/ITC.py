...
base_path = "./Fairness/RF/threshold/InviteToConduct/"
...
def likelihood_prediction(
    ...
    #     pred_data["did_interview"], predictions, save_path=save_dir
    # )
...
param_grid = {
    ...
    'classifier__max_depth': [10],  # Default: None (expand fully unless limited by other params)
    'classifier__min_samples_split': [10],  # Default: 2
    'classifier__min_samples_leaf': [1],  # Default: 1
    'classifier__class_weight': [ None],  # Default: None
}
