...
base_path = "./Fairness/RF/threshold/Prediction"
...
optimizer_ITC = joblib.load("./Fairness/RF/threshold/InviteToConduct/model/optimizer.pkl")
...
optimizer_OTR = joblib.load("./Fairness/RF/threshold/OfferToRegister/model/optimizer.pkl")
