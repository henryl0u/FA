...
base_path = "./Fairness/RF/reweight/Prediction"
...
model_ITC = joblib.load("./Fairness/RF/reweight/InviteToConduct/model/model.pkl")
...
model_OTR = joblib.load(f"Fairness/RF/reweight/OfferToRegister/model/model.pkl")
