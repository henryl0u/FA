...
base_path = "./Fairness/RF/egr/Prediction"
...
model_ITC = joblib.load("./Fairness/RF/egr/InviteToConduct/model/model.pkl")
# Load preprocessor used for InviteToConduct model
preprocessor_ITC = joblib.load("./Fairness/RF/egr/InviteToConduct/model/preprocessor.pkl")
...
model_OTR = joblib.load("./Fairness/RF/egr/OfferToRegister/model/model.pkl")
# Load preprocessor used for InviteToConduct model
preprocessor_OTR = joblib.load("./Fairness/RF/egr/OfferToRegister/model/preprocessor.pkl")
