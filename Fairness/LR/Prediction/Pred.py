...
base_path = "./Fairness/LR/Prediction"
...
model_ITC = joblib.load("./Fairness/LR/InviteToConduct/model/model.pkl")
...
model_OTR = joblib.load(f"Fairness/LR/OfferToRegister/model/model.pkl")
